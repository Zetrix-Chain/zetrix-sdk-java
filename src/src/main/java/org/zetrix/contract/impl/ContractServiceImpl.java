package org.zetrix.contract.impl;
...
import org.zetrix.common.Constant;
import org.zetrix.common.General;
...
import org.zetrix.model.request.operation.ContractCreateOperation;
import org.zetrix.model.request.operation.ContractInvokeByAssetOperation;
...
import org.zetrix.model.response.result.ContractCheckValidResult;
import org.zetrix.model.response.result.ContractGetAddressResult;
import org.zetrix.model.response.result.ContractGetInfoResult;
import org.zetrix.model.response.result.data.ContractAddressInfo;
import org.zetrix.model.response.result.data.ContractInfo;
...
public class ContractServiceImpl implements ContractService {
     ...
     * @Return org.zetrix.model.response.ContractCreateResponse
     * @Date 2018/7/5 13:31
     */
     ...
     * @Return org.zetrix.model.response.ContractInvokeByAssetResponse
     * @Date 2018/7/5 14:30
     */
    public static Chain.Operation invokeByAsset(ContractInvokeByAssetOperation contractInvokeByAssetOperation, String transSourceAddress) throws SDKException {
        ...
        try {
            ...
            if (code != null && issuer != null && assetAmount != null) {
     ...
     * @Return org.zetrix.model.response.ContractInvokeByGasResponse
     * @Date 2018/7/5 15:28
     */
    public static Chain.Operation invokeByGas(ContractInvokeByGasOperation contractInvokeByGasOperation, String transSourceAddress) throws SDKException {
        ...
        try {
            ...
            Long ztxAmount = contractInvokeByGasOperation.getZtxAmount();
            if (Tools.isEmpty(ztxAmount) || ztxAmount < 0) {
            ...
            operationPayCoin.setAmount(ztxAmount);
            if (!Tools.isEmpty(input)) {
