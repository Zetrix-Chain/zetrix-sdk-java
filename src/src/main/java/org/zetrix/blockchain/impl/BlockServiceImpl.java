...
import org.zetrix.model.request.*;
import org.zetrix.model.response.result.data.LedgerSeq;
import org.zetrix.model.response.result.data.Rewards;
import org.zetrix.model.response.*;
import org.zetrix.model.response.result.*;
...
public class BlockServiceImpl implements BlockService {
    ...
    public BlockGetRewardResponse getReward(BlockGetRewardRequest blockGetRewardRequest) {
        ...
        try {
            ...
            params.put("contract_address", "ZTX3ePNZQhndgGzKLmg1SFfno3N42mLhPYJMN");
