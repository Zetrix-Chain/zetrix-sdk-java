package org.zetrix.common;

public class ToBaseUnit {
    public static Long ToUGas(String ztxAmount) {
        return unitWithDecimals(ztxAmount, 6);
    }

    public static String ToGas(String amount) {
        return unitWithoutDecimals(amount, 6);
    }
